...
CREATE TABLE permission (
    ...
    /* Global settings */
    /* level_type_item */
    global_crud_users TINYINT(1) NOT NULL DEFAULT 0,
    global_crud_department TINYINT(1) NOT NULL DEFAULT 0,
    global_crud_role TINYINT(1) NOT NULL DEFAULT 0,
    global_crud_resources TINYINT(1) NOT NULL DEFAULT 0,
    global_assign_users_to_department TINYINT(1) NOT NULL DEFAULT 0,
    global_assign_users_to_role TINYINT(1) NOT NULL DEFAULT 0,
    global_assign_resources_to_department TINYINT(1) NOT NULL DEFAULT 0,
    global_assign_resources_to_role TINYINT(1) NOT NULL DEFAULT 0,
    global_view_reports TINYINT(1) NOT NULL DEFAULT 0,
    dept_crud_role TINYINT(1) NOT NULL DEFAULT 0,
    dept_crud_resources TINYINT(1) NOT NULL DEFAULT 0,
    dept_assign_users_to_role TINYINT(1) NOT NULL DEFAULT 0,
    dept_assign_resources_to_role TINYINT(1) NOT NULL DEFAULT 0,
    dept_view_reports TINYINT(1) NOT NULL DEFAULT 0,
    updated_by_user_id INT NOT NULL,
    created_on DATETIME NOT NULL DEFAULT NOW(),
    updated_on DATETIME NOT NULL DEFAULT NOW(),
    deleted_on DATETIME DEFAULT NULL,
